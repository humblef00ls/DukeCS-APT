...
export function setColors(lightMode) {
    ...
    document.documentElement.style.setProperty('--back',  lightMode ? '#d3dceb' : '#1c1c1c' );
        ...
        document.documentElement.style.setProperty('--accent',  lightMode ? '#012a4a' : '#eaf2ff' );
        document.documentElement.style.setProperty('--section',  lightMode ? 'rgba(242,242,242,1)' : '#363636' );
        if (lightMode) {
